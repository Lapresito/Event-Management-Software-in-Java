...
<body>
    ...
    <h1 class="text-center">Patrocinios de Edición: <%= edicionParam %></h1>
            ...
            <div class="row">
                ...
                %>
	                    <div class="col-12 col-sm-6 col-md-4 mb-4">
	                        <a  href="/webServer/patrocinios?edicion=<%=p.getNombreEdicion()%>&institucion=<%=p.getNombreInstitucion()%>" class="card text-center h-100 <%= p.getNivel()%>">
	                            ...
	                            <div class="card-footer text-body-secondary">
	                                <p>Fecha de alta: <%= p.getFechaAlta().toXMLFormat().split("T")[0] %></p>
	                            </div>
	                        </a>
	                    </div>
                <%
