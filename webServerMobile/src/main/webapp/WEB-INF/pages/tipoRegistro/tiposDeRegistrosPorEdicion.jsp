...
<body>
    ...
    <h3 class="text-center">Tipos de Registro de  <%= edicionParam %></h3>
            ...
            <div class="row">
                ...
                %>
	                <div class="col-12 col-sm-6 col-md-4 mb-4">
	                    <a href="<%=request.getContextPath()%>/tipoRegistro?evento=<%=eventoParam %>&edicion=<%=tr.getNombreEdicion()%>&tipoRegistro=<%=tr.getNombreTipoRegistro()%>" 
