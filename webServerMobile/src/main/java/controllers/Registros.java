  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    try {
      ...
      if (nickname == null || nickname.isEmpty()) { // quiero ver todos los registros
        ...
        boolean acceso = "organizador".equalsIgnoreCase(tipo) && usuario.getNickname().equals(edicion.getOrganizador());
        if (!acceso) {
        ...
        boolean acceso = usuario.getNickname().equals(nickname) || ("organizador".equalsIgnoreCase(tipo) && usuario.getNickname().equals(edicion.getOrganizador()));
        if (!acceso) {
          req.setAttribute("error", "Acceso No permitido.");
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      try {
          ...
          if ("confirmar".equalsIgnoreCase(accion)) {
              ...
              sistemaUsuarios.registrarAsistencia(nickname, nombreEdicion);

              req.setAttribute("exito", "Asistencia confirmada con éxito ✔");
